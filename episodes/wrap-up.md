...
[create formatted webpage content with Markdown](markdown/),
[configure a GitHub repository to use the Jekyll static site generator](github-pages/),
and [how to use Jekyll to build our Markdown pages and various other files](starting-jekyll/)
