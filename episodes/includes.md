...
This is related to the **DRY** (Don't Repeat Yourself) principle of
...
![](fig/includes_navigation_links_header.png){alt='A page displaying the navigation links header' .image-with-shadow width="800px" }
...
![](fig/includes_contact_links_footer.png){alt='A page displaying contact links as footer' .image-with-shadow width="800px" }
...
In the [Authoring with Markdown](markdown#reference-style-links) section,
