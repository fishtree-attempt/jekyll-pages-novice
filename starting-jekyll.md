...
![](fig/jekyll_fail_pending_successful.png){alt='Jekyll pending/successful/failed builds after different commits' .image-with-shadow width="800px" }
...
![](fig/jekyll_build_error.png){alt='Jekyll - a failed build' .image-with-shadow width="800px" }

Visiting the page behind the **Details** link will give us the information we were missing.

![](fig/jekyll_build_error_detail.png){alt='Jekyll - error details of a failed build' .image-with-shadow width="800px" }
...
of '[https://carpentries.github.io/lesson-example/](https://carpentries.github.io/lesson-example/)' and reference it in your `index.md`.
